...
public class PurchaseOrderBean implements Serializable {
	...
	public boolean isTcs_required() {
		return tcs_required;
	}
	public void setTcs_required(boolean tcs_required) {
		this.tcs_required = tcs_required;
	}
	@Override
