...
public class SalesDocumentBean implements Serializable {
	...
	public double getTcs_percent() {
		return tcs_percent;
	}
	public void setTcs_percent(double tcs_percent) {
		this.tcs_percent = tcs_percent;
	}
	public double getTcs_amount() {
		return tcs_amount;
	}
	public void setTcs_amount(double tcs_amount) {
	...
	public String toString() {
		return "SalesDocumentBean [id=" + id + ", invoice_id=" + invoice_id + ", customer_id=" + customer_id
				...
				+ timestamp + ", document=" + document + ", round_off=" + round_off + ", tcs_percent=" + tcs_percent
				+ ", tcs_amount=" + tcs_amount + ", documents=" + documents + "]";
	}
}
