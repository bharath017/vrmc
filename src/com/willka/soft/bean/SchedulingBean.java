...
public class SchedulingBean implements Serializable{
	...
	public String toString() {
		return "SchedulingBean [scheduling_id=" + scheduling_id + ", plant_id=" + plant_id + ", customer_id="
				+ customer_id + ", site_id=" + site_id + ", scheduling_date=" + scheduling_date + ", start_time="
				+ start_time + ", end_time=" + end_time + ", pump1=" + pump1 + ", pump2=" + pump2 + ", user_id="
				+ user_id + "]";
	}
}
