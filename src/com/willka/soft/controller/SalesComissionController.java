...
import com.willka.soft.dao.SalesComissionDAO;
import com.willka.soft.dao.SalesComissionDAOImpl;

/**
 * Servlet implementation class SalesComissionController
 */
@WebServlet("/SalesComissionController")
		...
		try {
			...
			if(action.equals("InsertPayment")) {
				...
				if(count>0) {
					...
					response.sendRedirect("SalesComissionList.jsp");
				}else {
