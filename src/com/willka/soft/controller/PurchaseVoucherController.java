...
import com.willka.soft.dao.PurchaseVoucherDAO;
import com.willka.soft.dao.PurchaseVoucherDAOImpl;
import com.willka.soft.util.IndianDateFormater;

/**
 * Servlet implementation class PurchaseVoucherController
 */
@WebServlet("/PurchaseVoucherController")
			...
			if(action.equals("InsertVoucher")) {
				synchronized (this) {
					...
					if(count>0) {
						...
						response.sendRedirect("PurchaseVoucherList.jsp");
					}else {
