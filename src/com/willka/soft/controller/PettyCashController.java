		...
		try {
			...
			if(action.equals("InsertPettyCash")) {
				...
				if(count>0) {
					...
					response.sendRedirect("PettyCashList.jsp");
				}else {
				...
				int received_person=Integer.parseInt(request.getParameter("received_person"));
				String purpose=request.getParameter("purpose");
