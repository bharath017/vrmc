...
public class SupplierDAOImpl implements SupplierDAO {
	...
	private static final String INSERT_QUERY="insert into supplier(supplier_name,supplier_phone,"
			+ "supplier_address,supplier_gstin,supplier_panno,business_id,opening_balance,supplier_email) values(?,?,?,?,?,?,?,?)";
	
	private static final String UPDATE_QUERY="update supplier set supplier_name=?,supplier_phone=?,supplier_address=?,"
			+ "supplier_gstin=?,supplier_panno=?,business_id=?,opening_balance=?, supplier_email=? where supplier_id=?";
	
	private static final String CHANGE_SUPPLIER_STATUS="update supplier set supplier_status=? where supplier_id=?";
	
	private static final String UPDATE_TALLYLEDGER = "update supplier set tally_ledger=? where supplier_id=?";
	...
	private static final String GET_SUPPLIER_LIST="select supplier_id,supplier_name,supplier_phone,"+
			...
			" from supplier s,business_group b"+
	...
	private static final String GET_SINGLE_SUPPLIER_DETAILS_BY_SUPPLIER_ID="select s.*,b.group_name"
			+ " from supplier s,business_group b where s.business_id=b.business_id and  supplier_id=?";
