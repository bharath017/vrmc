...
public interface PettyCashDAO {
	...
	public List<Map<String,Object>> getPettyCashTransactionDateWiseReport(String from_date, String to_date,String category_type,int category_id)throws Exception;
	
	public List<Map<String,Object>> getAccountTransactionReport(String from_date, String to_date, String category_type,int category_id)throws Exception;
