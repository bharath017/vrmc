...
import com.willka.soft.test.dao.DCDAO;
import com.willka.soft.test.dao.DCDAOImpl;
import com.willka.soft.util.Batchsheet_VRMC;
import com.willka.soft.util.Batchsheet_VRMCT;
import com.willka.soft.util.DBUtil;

/**
 * Servlet implementation class InvoiceController
 */
@WebServlet("/DCControllerTest")
...
//					InvoiceBean bean=new InvoiceBean();
					...
					if(count>0) {
						session.setAttribute("res", "DC Id "+count+" generated succesfully");
						response.sendRedirect("gst/DCList.jsp");
					}else {
...
//					InvoiceModificationBean been=new InvoiceModificationBean();
					...
					session.setAttribute("res", "DC Id "+invoice_id+" Updated succesfully");
					response.sendRedirect("gst/DCList.jsp");
				}else {
					session.setAttribute("res", "<span class='text-danger'>Failed!!</span>");
					response.sendRedirect("gst/DCList.jsp");
...
//					InvoiceModificationBean bean=new InvoiceModificationBean();
				...
				try {
					...
					Batchsheet_VRMCT batch=new Batchsheet_VRMCT();
