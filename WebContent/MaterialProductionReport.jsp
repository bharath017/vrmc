...
<head>
        <meta charset="utf-8" />
        <title>Production Stock Report</title>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Production Stock Report</h4>
                        </div>
                    </div>
                </div>
                 <!-- end row -->
                          ...
                          <div class="row">
                          	<div class="form-group col-sm-2">
                          		...
                          		<select class="form-control" id="report_type">
                          			...
                          			<option value="stock">Production Sheet</option>
                          		</select>
                          	</div>
       ...
       <%@ include file="footer.jsp" %>
        ...
        <script type="text/javascript" src="js/Production/MaterialStockReport.js"></script>
