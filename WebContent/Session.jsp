...
<%
 ...
 response.setHeader("Pragma","no-cache"); //HTTP 1.0 backward compatibility
	...
	}else if(uname.equals("sgst") || uname.equals("gstbilling") || uname.equals("gstqc")  
					|| uname.equals("gstadmin") || uname.equals("gststore") ||
					 uname.equals("gstaccount") || uname.equals("gstmarketing")){
		session.invalidate();
		response.sendRedirect("login.jsp");
	}
%>