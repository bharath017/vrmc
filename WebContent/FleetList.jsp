       ...
       <%@ include file="header.jsp" %>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-4">
                    <a href="AddFleet.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add Incoming Item</a>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
                            ...
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                              ...
                              <c:set value="${(empty param.incoming_date)?'':param.incoming_date}" var="incoming_date"/>
								...
								<sql:query var="fleet" dataSource="jdbc/rmc">
                                	select f.*,(select plant_name from plant where plant_id=f.plant_id) as plant_name from fleet_incoming f where incoming_date like if(''=?,'%%',?) and bill_no like if(''=?,'%%',?) and plant_id like if(?=0,'%%',?) order by fleet_id desc limit 200
     ...
     <script type="text/javascript">
	    $(document).ready(function(){
	    	$('#search').on('click',function(){
	    		var incoming_date=$('#incoming_date').val();
	    		var bill_no=$('#bill_no').val();
	    		window.location='FleetList.jsp?incoming_date='+incoming_date+'&bill_no='+bill_no;
	    	});
	    });
    </script>
    <script>
