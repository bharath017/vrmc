			                 ...
			                 <div class="form-group">
                                ...
                                <div class="form-group">
			                       ...
			                       <sql:query var="supplier" dataSource="jdbc/rmc">
									...
									<select name="received_person" id="received_person-transaction" class="form-control"   data-placeholder="Choose Employee">
										<option value="" >Choose Employee</option>
										<c:forEach var="sup" items="${supplier.rows}">
										<option value="${sup.e_id}">${sup.employee_name}</option>
										</c:forEach>
									</select>
			                    </div>
			                 <div class="form-group">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal text-left" action="#"  method="post" id="transaction-update-form">
		                	...
		                	<div class="form-group">
		                        ...
		                        <div>
		                            <div class="input-group">
		                                <input type="text" name="date" id="date-transaction-update" class="form-control date-picker " placeholder="yyyy-mm-dd" id="id-date-picker-1" data-date-format="yyyy-mm-dd">
		                                <div class="input-group-append picker">
		                                    <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
		                                </div>
		                            </div>
			                ...
			                <div class="form-group">
                                ...
                                <div class="form-group">
			                       ...
			                       <sql:query var="supplier" dataSource="jdbc/rmc">
									...
									<select name="received_person" id="received_person-transaction-update" class="form-control"   data-placeholder="Choose Employee">
										<option value="" >Choose Employee</option>
										<c:forEach var="sup" items="${supplier.rows}">
										<option value="${sup.e_id}">${sup.employee_name}</option>
										</c:forEach>
