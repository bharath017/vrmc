...
<sql:query var="invoice" dataSource="jdbc/rmc">
	select c.*,cu.customer_name,cu.customer_gstin,
...
<table class="table"  style="width: 100%">
				...
				<tr>
					<td colspan="11" align="center" style="border:1px solid black;"><P style="font-size: 2.0em;">CONSOLIDATED TAX INVOICE</P>
					</td>
				</tr>
				<tr>
					<td class="text-center" colspan="3">
						<img src="image/logo/smlpconcrete.PNG" class="img img-rounded"
									width="150" height="80">
					</td>
					<td class="text-center" colspan="11">
							<h2><strong>SMLP CONCRETE</strong></h2>
							<p>Address : Address : No 32, Shettarahalli Village, Kasaba Hobli, Devanahalli Taluk, Bangalore Rural,Karnataka - 562110<br>
							Phone : 9071533345<br>
							Email: smlpconcrete@gmail.com<br>
							GSTIN: 29ABSPU3976C3ZU</p>
					</td>
				</tr>
				...
				<sql:query var="item" dataSource="jdbc/rmc">
					select i.invoice_id,i.vehicle_no,DATE_FORMAT(i.invoice_date,'%d/%m/%Y') as invoice_date,
					p.product_name,i.quantity,s.site_address,i.rate,i.gross_amount,i.tax_amount,i.net_amount
					from consolidate_invoice_item si LEFT JOIN(invoice i,site_detail s,product p,purchase_order_item poi)
					ON si.id=i.id
				...
				<tr>
					...
					<h5><b><u>Payment Account Details:</u></b></h5>
					SMLP CONCRETE<br>KARNATAKA BANK<br>
                                   9092000100048901<br>
                                   KARB0000909<br>
                                   YELAHANKA NEW TOWN BRANCH	
					</td>
					<td colspan="3" class="text-right">TOTAL (RS.) : </td>
					<td colspan="3">${total_net}</td>
				</tr>
				<tr>
					
					<td colspan="3" class="text-right">PUMP CHARGE (RS.) : </td>
					<td colspan="3">${rs.pump_charge}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" id="amtt">${total_net}</td>
				</tr>
				<tr>
					<td colspan="11">
