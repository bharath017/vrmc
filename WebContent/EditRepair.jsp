...
<head>
	...
	<div class="wrapper">
		<div class="container-fluid">
					...
					<div class="page-title-box">
						<div class="btn-group pull-right">
							<ol class="breadcrumb hide-phone p-0 m-0">
								...
								<li class="breadcrumb-item"><a href="#"> Edit Vehicle Repair Details</a></li>
			...
			<div class="row">
					 <div class="col-sm-4">
                        <a href="VehicleRepairList.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i>Follow Up Report List</a>
                    </div>
             </div>
             
             
             <sql:query var="diesel" dataSource="jdbc/rmc">
				select * from repair where gp_no=?
				<sql:param value="${param.gp_no}"/>
			</sql:query>
			...
			<div class="row">
				<div class="col-sm-12">
							...
							<form action="RepairController?action=UpdateRepair" method="post" id="service-form">
							...
							<div class="col-sm-6">
							 ...
							 <div class="form-group">
								...
								<div class="form-group">
                                       <label>Date <span class="text-danger"></span> </label>
                                           ...
                                           <div class="input-group">
                                               <input type="text" name="repair_date" value="${rs.repair_date}"  class="form-control date-picker repair_date"  placeholder="yyyy-mm-dd" id="id-date-picker-1" data-date-format="yyyy-mm-dd">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <input type="text" name="repair_time"  class="form-control" value="${rs.repair_time}" placeholder="HH:MM:SS" id="timepicker1" data-date-format="yyyy-mm-dd">
                                            <div class="input-group-append">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                          placeholder="Enter Vendor Name" value="${rs.vendor}"  id="vendor" name="vendor"/>
                                    </div>
	                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div>
                                       <input type="text" class="form-control" 
                                          placeholder="Enter Received Person's Name" value="${rs.received_person}"  id="received_person" name="received_person"/>
                                    </div>
                                    </div>
                                </div>
                           ...
                           <div class="col-sm-6">
                         		 ...
                         		 <div class="form-group">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                          placeholder="Enter Place"  value="${rs.place}" id="place" name="place"/>
                                          <input type="hidden" name="gp_no" value="${rs.gp_no}"/>
                                    </div>
	                            </div>
	                            ...
	                            <div class="form-group">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                          placeholder="Enter Repair Cost in Rs"  value="${rs.repair_cost}" id="repair_cost" name="repair_cost"/>
                                    </div>
	                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-group">
                                           <textarea class="form-control" name="remarks" >${rs.remarks}</textarea>
