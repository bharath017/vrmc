...
<head>
	...
	<div class="wrapper">
		<div class="container-fluid">
			...
			<!-- Get the details of the diesel consumption -->
			
			<sql:query var="diesel" dataSource="jdbc/rmc">
				select * from diesel_consumption where diesel_id=?
				<sql:param value="${param.diesel_id}"/>
			</sql:query>
			...
			<div class="row">
				<div class="col-sm-12 row">
					<div class="col-sm-8">
							<form action="DieselConsumptionController?action=UpdateConsumption" method="post" id="consumption-form">
							<div class="card-box row col-sm-12">
								<div class="form-group col-sm-10">
                                       <label>Issued Date <span class="text-danger"></span> </label>
                                       <div>
                                           <div class="input-group">
                                               <input type="text" name="issued_date"  value="${rs.issued_date}" class="form-control date-picker issued_date"  placeholder="yyyy-mm-dd" id="id-date-picker-1" data-date-format="yyyy-mm-dd">
                                               <input type="hidden" name="diesel_id" value="${rs.diesel_id}">
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <input type="text" name="issued_time" value="${rs.issued_time}"  class="form-control"  placeholder="HH:MM:SS" id="timepicker1" data-date-format="yyyy-mm-dd">
                                            <div class="input-group-append">
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                          placeholder="Enter Quantity In Litre" value="${rs.issued_quantity}"   id="issued_quantity" name="issued_quantity"/>
                                    </div>
	                            </div>
	                            ...
	                            <div class="form-group col-sm-10">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                           placeholder="Enter Opening KM" id="opening_km" value="${rs.opening_km}"  name="opening_km"/>
                                    </div>
	                            </div>
	                            ...
	                            <div class="form-group col-sm-10">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                           placeholder="Enter Closing KM"  id="closing_km" value="${rs.closing_km}" name="closing_km"/>
                                    </div>
	                            </div>
                                ...
                                <div class="form-group col-sm-10">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                         pattern="[^'&quot;:]*$"   placeholder="Enter Issued Person Name" value="${rs.issued_person}"   id="issued_person" name="issued_person"/>
                                    </div>
	                            </div>
	                            ...
	                            <div class="form-group col-sm-10">
                                    ...
                                    <div>
                                       <textarea class="form-control" style="border: 1px solid red;" id="comment" name="comment" placeholder="Enter Comment"></textarea>
                                    </div>
	                            </div>
