        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Bank/Cash Details</h4>
                        </div>
                    </div>
                </div>
				...
				<sql:query var="gst" dataSource="jdbc/rmc">
					select b.*,g.group_name as gname,b.group_name
                ...
                <div class="row">
                    <div class="col-12 text-center">
                    	<a href="AddBankDetails.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-toggle="modal" data-target="#add-comp" data-overlayColor="#36404a"><i class="mdi mdi-plus"></i>Add Bank/Cash Detail</a>
                    	<table class="table table-bordered">
                    		...
                    		<tbody>
                    			<c:forEach items="${bk}" var="bank">
                    				<c:if test="${bank.group_name=='bank'}">
                    					<tr>
	                    					<td id="${bank.bank_detail_id}" class="bankid">${bank.bank_detail_id}</td>
	                    					<td>${bank.bank_name} - (${bank.gname})</td>
	                    					<td>${bank.account_no}</td>
	                    					<td class="viewbalance">
	                    						<img alt="loader" src="loader/loader.svg" id="loader" width="25" height="25"/>
	                    					</td>
											...
											<td>
												<a href="#delete-model" class="text-danger" 
													onclick="deleteGSTPercent('${bank.bank_detail_id}','${bank.bank_name}',
														'${bank.ifsc_code}','${bank.account_no}','${bank.branch_name}','${bank.amount}','${bank.business_id}');" 
				...
				<div id="delete-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="BankDetailController?action=updateBankDetail">
...
<!-- 		                            <button class="btn w-lg btn-rounded btn-custom btn-danger waves-effect waves-light"   type="button">CANCEL</button> -->
<!-- 		                        </div> -->
<!-- 		                    </div> -->
		                </form>
		            </div>
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
        		 ...
        		 let from_date='01/01/2000';
        		 let to_date='01/01/2050';
        		$('.table').each(function(){
        			$(this).find('tbody tr').each(function(){
        				let that=$(this);
        				let bank_detail_id=$(this).closest('tr').find('.bankid').attr('id');
        				$.ajax({
        					type:'post',
        					...
        					success:function(res){
								...
								that.find('.viewbalance').text(Math.round(balance*100)/100);       						
        					}
        				});
        			});
        		});
