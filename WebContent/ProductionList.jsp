       ...
       <%@ include file="header.jsp" %>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="AddProductStock.jsp" class="btn btn-custom waves-effect waves-light mb-4"
                        		  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add Production </a>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
                <form id="clear-form">
				<div class="row filter-row">
                    ...
                    <div class="col-sm-2 col-xs-6">
                        <div class="form-group form-focus select-focus">
                            <label class="control-label">Product <span class="text-custom">*</span> </label>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            ...
                            <c:remove var="res"/>
                            <table id="example" 
                            		class="table table-striped table-bordered table-condensed text-center" cellspacing="0" width="100%">
                                <thead>
	                                <tr>
										<th class="center">
											Production ID
        ...
        <script type="text/javascript" src="js/Production/ProductionList.js"></script>
