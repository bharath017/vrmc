        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <!-- end page title end breadcrumb -->
                 <div class="row">
                    <div class="col-sm-4">
                        <a href="FleetList.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i>Incoming Fleet List</a>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
								...
								<div class="col-sm-8">
									<div class="form-group">
										<label>Comment <span class='text-danger'>*</span></label> <input
											class="form-control" type="text" id="comment" name="comment">
									</div>
								</div>
		                            ...
		                            <div class="row">
		                                ...
		                                <div class="col-sm-4">
		                                    <div class="form-group">
		                                        <label>Incoming Date<span class="text-danger">*</span></label>
		                                        <div class="cal-icon">
		                                            <input class="form-control datepicker3"  required="required" name="incoming_date" type="text">
		                                        </div>
		                                    </div>
		                                </div>
		                                ...
		                                <div class="col-sm-4">
		                                   <div class="form-group">
		                                       <label>Incoming Time<span class="text-danger">*</span></label>
												<div class="cal-icon">
													<input name="incoming_time" required="required" id="timepicker1" type="text"  data-date-format="yyyy-mm-dd" class="form-control" />
       ...
       <%@ include file="footer.jsp" %>
		...
		<script type="text/javascript" src="js/AddPurchaseOrder.js"></script>
		 ...
		 <script type="text/javascript">
		   ...
		   $.ajax({
			   type:'POST',
			   url:'SettingController?action=checkExistanceOfGSTSetting',
			   headers:{
