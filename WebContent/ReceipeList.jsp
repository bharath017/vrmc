...
<head>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
								...
								<sql:query var="rec" dataSource="jdbc/rmc">
									...
									from receipe r LEFT JOIN(product p,site_detail s,customer c,plant pl)
										...
										<td class="text-center">
											 <div class="btn-group dropdown">
	                                            ...
	                                            <div class="dropdown-menu dropdown-menu-right">
	                                            	<a class="dropdown-item" href="PrintReceipe.jsp?receipe_id=${rec.receipe_id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Print Receipe</a>
				...
				<div id="dele-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" action="MixDesignController?action=DeleteReceipe" method="post">
    ...
    <script type="text/javascript">
    	function getSingleReceipeView(receipe_id){
    		$.ajax({
    			type:'POST',
    			url:'MixDesignController?action=GetSingleReceipe&receipe_id='+receipe_id,
    			headers:{
    				Accept:"application/json;charset=utf-8",
    				"Content-Type":"application/json;charset=utf-8"
    			},
