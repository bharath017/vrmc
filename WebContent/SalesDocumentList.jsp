...
<head>
    ...
    <body>
       ...
       <%@ include file="header.jsp" %>
            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Sales Document</li>
                                    <li class="breadcrumb-item active">Sales Document List</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Sales Document List</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-xs-6 col-sm-3 text-center" >
                        <div class="card-box widget-flat  text-white " style="background-color: #6c757d;border-color:#6c757d;">
                            <i class=" fa fa-money"></i>
                            <h5 class="m-b-10" id="inactive"></h5>
                            <p class="text-uppercase m-b-5 font-13 font-600">Today Invoice</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <div class="card-box widget-flat text-white" style="background-color: #6c757d;border-color:#6c757d;">
                            <i class=" fa fa-money"></i>
                            <h5 class="m-b-10" id="recomanded"></h5>
                            <p class="text-uppercase m-b-5 font-13 font-600">This Week Invoice</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <div class="card-box widget-flat text-white" style="background-color:  #6c757d;border-color: #6c757d;">
                            <i class=" fa fa-money"></i>
                            <h5 class="m-b-10" id="thismonthactive"></h5>
                            <p class="text-uppercase m-b-5 font-13 font-600">This Month Invoice </p>
                        </div>
                    </div>
                    
                    <div class="col-xs-6 col-sm-3 text-center" id="bill_not_received">
                        <div class="card-box widget-flat text-white" style="background-color: #6c757d;border-color:#6c757d;">
                            <i class=" fa fa-money"></i>
                            <h5 class="m-b-10" id="thismonthindent"></h5>
                            <p class="text-uppercase m-b-5 font-13 font-600">This Month Cancelled</p>
                            <input type="hidden" value="" id="pending-status"/>
                        </div>
                    </div>
				</div>
				<form id="clear-form">
				<div class="row filter-row">
					<div class="col-sm-2 col-xs-6">
                        <div class="form-group form-focus">
                            <label class="control-label">Invoice Id <span class="text-custom">*</span></label>
                                <input class="form-control" placeholder="Enter Invoice ID" id="invoice_id" type="text" name="invoice_id">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            ...
                            <table id="example" class="table  table-bordered table-condensed text-center" cellspacing="0" width="100%">
                                <thead>
	                                <tr style="color: white;background-color:#6c757d; ">
										<th>Invoice ID</th>
										<th class="center">
											Date 
										</th>
										...
										<th class="text-center" style="width: 40%;">
											<table class="table tbl" >
												<tr style="color: white;background-color:#6c757d;">
													<td style="border:1px solid white;width: 44%;">Item Name</td>
													<td style="border:1px solid white; width: 10%;">Rate</td>
													<td style="border:1px solid white;width: 10%;">Quantity</td>
													<th style="border:1px solid white;width: 12%;">Gross Amount</th>
													<th style="border:1px solid white;width: 12%;">Tax Amount</th>
													<th style="border:1px solid white;width: 12%;">Net Amount</th>
												</tr>								
											</table>
										</th>
        ...
        <script type="text/javascript" src="js/SalesDocument/SalesDocumentList.js"></script>
