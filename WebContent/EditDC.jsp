        ...
        <div class="wrapper">
            <div class="container-fluid">
               ...
               <sql:query var="invoice" dataSource="jdbc/rmc">
               	    ...
               	    from dc i LEFT JOIN(customer c,site_detail s,purchase_order_item poi,purchase_order po,product p)
              ...
              <c:forEach items="${invoice.rows}" var="invoice">
              	...
              	<div class="row">
                    <div class="col-sm-12">
                    	<form class="" id="myform" action="DCController?action=UpdateInvoice" method="post">
	                                    ...
	                                    <div>
	                                       <sql:query var="grade" dataSource="jdbc/rmc">
											...
											<select id="product_id" required="required"  name="loaded_product_id"   class="select2"  data-placeholder="Choose Grade">
												...
												<option value="${grade.product_id}" ${(grade.product_id==rs.product_id)?'selected':''}>${grade.product_name}</option>
												</c:forEach>
											</select>
	                                    </div>
	                                </div>
	                                 ...
	                                 <div class="col-sm-6 form-group">
	                                    ...
	                                    <div>
	                                       <input type="number" class="form-control" 
	                                          step="0.01"     id="km_reading" value="${rs.km_reading2}" name="km_reading2"/>
	                                    </div>
	                                </div>
	                                </div>
	                                  <div class="form-group">
