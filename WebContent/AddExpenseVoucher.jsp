                ...
                <c:choose>
                	<c:when test="${param.action=='update'}">
                		...
                		<sql:query var="expense" dataSource="jdbc/rmc">
                		    ...
                		    from expense_voucher e where expense_voucher_id=?
                		...
                		<c:forEach items="${expense.rows}" var="expense">
               			...
               			<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" id="myForm" action="ExpenseVoucherController?action=UpdateExpenseVoucher" method="post">
			                             ...
			                             <div class="col-sm-12" id="clicked">
		                                	<table class="table table-bordered" id="Table1">
		                                		...
		                                		<sql:query var="item" dataSource="jdbc/rmc">
		                                			select * from expense_voucher_item where expense_voucher_id=?
		                                			<sql:param value="${param.expense_voucher_id}"/>
		                                		</sql:query>
                	...
                	<c:otherwise>
                		<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" id="myForm" action="ExpenseVoucherController?action=InsertExpenseVoucher" method="post">
			                        <div class="card-box row col-sm-12">
			                           	<div class="col-sm-3">
			                           	   <div class="form-group">
			                                    <label>Bill No : </label>
