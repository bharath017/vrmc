                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Modified Fleet List</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Recent Fleet Modified List</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                                <thead>
	                                <tr>
										<th class="text-center">Fleet Edit Id</th>
...
<%--                                  <c:set value="${(empty param.fleet_id)?'':param.fleet_id}" var="fleet_item_id"/>
 --%>								<sql:query var="flt" dataSource="jdbc/rmc">
                                	 
                                select * from fleet_incoming_edit	 
                                	 
                                </sql:query>
                                <tbody>
                               <c:forEach items="${flt.rows}" var="item">
									<tr>
										    <td class="text-center">${item.fin_edit_id}</td>
	                                        <td class="text-center">${item.old_amount}</td>
	                                        <td class="text-center">${item.new_amount}</td>
	                                        <td class="text-center">${item.edited_comment}</td>
	                                        <td class="text-center">${item.edited_user}</td>
	                                        <td class="text-center">${item.edited_timestamp}</td>
										</tr>
									</c:forEach>
                                </tbody>
                            </table>
