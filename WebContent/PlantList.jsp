...
<head>
        <meta charset="utf-8" />
        <title>PlantList - ${initParam.company_name}</title>
    ...
    <body>
       ...
       <%@ include file="header.jsp" %>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Plant List</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">Plant List</h4>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
	                                <tr>
										...
										<th class="center">Business Group</th>
										<th class="center">OPTION</th>
									</tr>
                                </thead>
								<sql:query var="plant" dataSource="jdbc/rmc">
									select p.*,g.group_name
								    from plant p,business_group g
								    where p.business_id=g.business_id
								</sql:query>
                                <tbody>
                                <c:forEach var="plant" items="${plant.rows}">
									<tr>
										<td class="center" style="width: 20%;"><a href="PlantView.jsp?plant_id=${plant.plant_id}">${plant.plant_name}</a></td>
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												<a class="green"  href="AddPlant.jsp?action=update&plant_id=${plant.plant_id}">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												&nbsp;&nbsp;
												<a class="red"  href="#delete-model" data-animation="blur" data-plugin="custommodal"
				...
				<div id="delete-model" class="modal-demo col-xs-2">
		            ...
		            <h4 class="custom-modal-title" style="color: white;background-color: #491136;">Delete Plant : <span class="plant_name"></span> </h4>
        ...
        <script type="text/javascript">
			function deletePlant(plant_id,plant_name){
