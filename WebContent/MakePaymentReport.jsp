...
<head>
    ...
    <body>
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Make Payment  Report</a></li>
                                </ol>
                            </div>
                ...
                <div class="row card">
                    <div class="col-md-12">
                       <form action="#" id="myform"
                       		 method="post">
                          <div class="row">
                            <div class="form-group col-sm-2" style="display: ${(bean.business_id==0)?'block':'none'}">
                          	...
                          	<div class="form-group col-sm-2">
                          		...
                          		<select class="form-control" id="report_type">
                          			...
                          			<option value="supplierdate">Supplier With Date</option>
                          			<option value="bank">Bank Wise</option>
                          			<option value="transaction">Purchase Transaction</option>
                          		</select>
                          	</div>
                          	<div class="form-group col-sm-2 date no-supplier supplierdate bank transaction">
                                <label for="from_date">From Date <span class="text-danger"></span> </label>
                                <div>
                                    <div class="input-group">
                                        <input type="text" name="from_date" class="form-control date-picker from_date date no-supplier supplierdate bank transaction"
                                        		 required="required" placeholder="dd/mm/yyyy" id="from_date"
                           ...
                           <div class="form-group col-sm-2 date no-supplier supplierdate bank transaction">
                                ...
                                <div>
                                    <div class="input-group">
                                        <input type="text" name="to_date" class="form-control date-picker to_date date no-supplier supplierdate bank transaction"
                                        		 required="required" placeholder="dd/mm/yyyy" id="to_date"
                           ...
                           <div class="form-group col-sm-2  no-date no-bank supplier supplierdate no-bank no-transaction">
                                <label>Supplier <span class="text-danger">*</span></label>
                                <select class="select2 no-date supplier supplierdate no-bank no-transaction" name="supplier_id"
                                		 id="supplier_id" required="required">
                                </select>
                           </div>
                           
                           <div class="form-group col-sm-2 no-date no-supplier no-supplierdate bank no-transaction">
                                <label>Bank <span class="text-danger">*</span></label>
                                <select class="select2  no-date no-supplier no-supplierdate bank no-transaction" name="bank_detail_id"
                                		 id="bank_detail_id" required="required">
       ...
       <%@ include file="footer.jsp" %>
        ...
        <script type="text/javascript" src="js/Accounts/MakePayment/MakePaymentReport.js"></script>
