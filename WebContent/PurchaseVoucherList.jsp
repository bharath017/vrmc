...
<head>
        <meta charset="utf-8" />
        <title>Purchase Voucher List</title>
    ...
    <body>
       ...
       <%@ include file="header.jsp" %>
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Purchase Voucher</li>
                                    <li class="breadcrumb-item active">Purchase Voucher List</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Purchase Voucher List</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-xs-6 col-sm-3 text-center" >
                        <div class="card-box widget-flat  text-white" style="background-color: #f0b930;border-color:#f0b930;">
                            ...
                            <h5 class="m-b-10" id="thisweak"></h5>
                            <p class="text-uppercase m-b-5 font-13 font-600">THIS MONTH PURCHASE</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <div class="card-box widget-flat text-white" style="background-color: #307df0;border-color:#307df0;">
                            <i class=" fa fa-money"></i>
                            <h5 class="m-b-10" id="lastweak"></h5>
                            <p class="text-uppercase m-b-5 font-13 font-600">LAST MONTH PURCHASE</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
        ...
        <script type="text/javascript" src="js/Accounts/PurchaseVoucher/purchase_voucher_list.js"></script>
