                        ...
                        <div class="card-box table-responsive">
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                                ...
                                <sql:query var="payment" dataSource="jdbc/rmc">
                                	select p.*,c.customer_name from customer_payment_modification p left join customer c on p.customer_id=c.customer_id where p.customer_id like if(''=?,'%%',?) and payment_id like if(''=?,'%%',?)  order by payment_id desc limit 200
