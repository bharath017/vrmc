	...
	<div class="container">
			...
			<table class="table table-condensed"  style="width: 100%">
				...
				<tr>
					...
					<td colspan="4" class="col-xs-6" style="padding-top: 10px;padding-bottom: 10px;"><b>Invoice No: <fmt:formatNumber value="${rs.invoice_id}" minIntegerDigits="5" groupingUsed="false" maxFractionDigits="0"/></b></td>
				</tr>
				<tr>
				...
				<tr class="text-center">
					...
					<td>
						<fmt:formatNumber value="${sdi.item_price}" maxFractionDigits="2" groupingUsed="false"/>
					</td>
					<td colspan="1">${sdi.unit_of_measurement}</td>
					<td colspan="2" class="text-right">${sdi.net_price}</td>
				</tr>
				</c:forEach>
