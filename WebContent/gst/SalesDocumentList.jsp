            ...
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <div class="col-xs-6 col-sm-3 text-center" >
                        <div class="card-box widget-flat  text-white " style="background-color: #795804;border-color:#795804;">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center" id="bill_not_received">
                        <a class="btn btn-custom" href="AddSalesDocument.jsp">
                    ...
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            ...
                            <table id="example" class="table  table-bordered table-condensed text-center" cellspacing="0" width="100%">
                                <thead>
	                                <tr style="color: white;background-color:#795804; ">
										<th>Invoice ID</th>
										<th class="center">
											Date 
										</th>
