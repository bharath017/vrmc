              	...
              	<c:choose>
              		<c:when test="${param.action=='update'}">
                		...
                		<c:forEach items="${payment.rows}" var="payment">
              			...
              			<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" id="myform" action="../MakePaymentControllerTest?action=updateMakePayment" method="post">
              		...
              		<c:otherwise>
              			<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" id="myform" action="../MakePaymentControllerTest?action=InsertMakePayment" method="post">
			                        <div class="card-box row col-sm-12">
			                        	<div class="col-sm-4">
											 <div class="form-group">
			                                    <label>Supplier Name <span class="text-danger">*</span></label>
