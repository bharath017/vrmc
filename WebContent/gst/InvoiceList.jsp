            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card-box table-responsive">
                            ...
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
								...
								<c:choose>
									<c:when test="${usertype=='gst'}">
										<sql:query var="invoice" dataSource="jdbc/rmc">
											select i.*,c.customer_name,s.site_name,p.product_name,pl.plant_name
											from test_invoice i LEFT JOIN (test_customer c,test_site_detail s,test_purchase_order_item poi,product p,plant pl)
									...
									<c:otherwise>
										<sql:query var="invoice" dataSource="jdbc/rmc">
											...
											and i.vehicle_no like if(''=?,'%%',?)
											and i.plant_id like if(0=?,'%%',?)
											and i.invoice_date >= ( CURDATE() - INTERVAL 2 DAY )
											and i.state='show'
											order by i.id desc
											limit 50;
											<sql:param value="${invoice_id}"/>
											 ...
											 <div class="btn-group dropdown">
	                                            ...
	                                            <div class="dropdown-menu dropdown-menu-right">
	                                            	...
	                                            	<c:if test="${invoice.invoice_status=='active'}">
	                                            		<a class="dropdown-item" href="PrintInvoice.jsp?id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Print Invoice</a>
		                                            	...
		                                            	<a class="dropdown-item" href="../InvoiceControllerTest?action=DownloadBatchSheet&id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Download Batch Sheet</a>
		                                           	    ...
		                                           	    <a class="dropdown-item" href="../InvoiceControllerTest?action=RefreshInvoice&id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Refresh Invoice</a>
                      ...
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" name="update_vehicle" action="../InvoiceControllerTest?action=UpdateVehicle" method="post">
				...
				<div id="delete-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" action="../InvoiceControllerTest?action=UpdateDateTime" method="post">
		                	<div class="form-group">
				...
				<div id="cancel-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="../InvoiceControllerTest?action=CancelInvoice">
				...
				<div id="docket_modal" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="../InvoiceControllerTest?action=ChangeDocketNo">
				...
				<div id="deleteinvoice-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="../InvoiceControllerTest?action=DeleteInvoice">
