        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <!-- end page title end breadcrumb -->
                 <div class="row">
                    <div class="col-sm-4">
                        <a href="SalesComissionList.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i>Sales Commission List</a>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
              	...
              	<c:choose>
              		<c:when test="${param.action=='update'}">
                		...
                		<c:forEach items="${payment.rows}" var="payment">
              			...
              			<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" id="myform" action="../TestSalesComissionController?action=UpdatePayment" method="post">
              		...
              		<c:otherwise>
              			<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" id="myform" action="../TestSalesComissionController?action=InsertPayment" method="post">
			                        <div class="card-box row col-sm-12">
			                        	<div class="col-sm-2"></div>
			                           	<div class="col-sm-6">
			                           	   <div class="form-group">
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
    		$('#customer_id').on('change',function(){
				...
				$.ajax({
					type:'POST',
					url:'../PaymentControllerTest?action=GetCreditAmount&customer_id='+customer_id,
					headers:{
