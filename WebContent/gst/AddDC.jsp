...
<head>
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <!-- end row -->
              	...
              	<div class="row">
                    <div class="col-sm-12">
                    	<form class="" id="myform" action="../DCControllerTest?action=InsertInvoice"  method="post">
	                           	...
	                           	<div class="col-sm-6">
	                           	   ...
	                           	   <div class="form-group">
	                                    ...
	                                    <sql:query var="customer" dataSource="jdbc/rmc">
	                                    	select * from test_customer where customer_status='active' and customer_id in (select customer_id from test_scheduling where scheduling_date = curdate()) order by customer_name asc 
	                            ...
	                            <div class="col-sm-6">
	                              <div class="form-group">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div>
	                                       <input type="text" value="OPC53" class="form-control" name="km_reading"/>
	                                    </div>
	                                </div>
       ...
       <%@ include file="../footer.jsp" %>
		...
		<script src="js/add_dc.js"></script>
