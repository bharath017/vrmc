            ...
            <div class="container-fluid">
                ...
                <c:choose>
                	<c:when test="${param.action=='update'}">
                		<div class="row">
		                	...
		                	<sql:query var="cons" dataSource="jdbc/rmc">
		                		select * from test_consolidate_invoice where consolidate_invoice_id=?
		                    ...
		                    <div class="col-md-12">
		                       <form action="../InvoiceControllerTest?action=UpdateConsolidateInvoice" id="myform" method="post">
		                          <div class="row">
		                               ...
		                               <c:if test="${rs.invoice_type=='customerdate'}">
			                                ...
			                                <div class="col-sm-12">
			                                  <div class="form-group">
			                                      <label>From Date<span class="text-danger">*</span></label>
			                                      <div class="cal-icon">
			                                          <input type="text" name="_date" class="form-control date-picker" value="${rs.to_date}"  required="required" placeholder="yyyy-mm-dd" id="id-date-picker-1" data-date-format="yyyy-mm-dd">
			                                      </div>
			                                  </div>
			                                </div>
		                               </c:if>
                	...
                	<c:otherwise>
	                    ...
	                    <div class="col-md-12">
	                       <form action="../InvoiceControllerTest?action=generatecons" id="myform" method="post">
	                          <div class="row">
	                          	<div class="col-sm-3"></div>
	                          	<div class="col-sm-6">
	                          		<div class="col-sm-12">
	                               ...
	                               <div class="col-sm-12">
	                                ...
	                                <div class="col-sm-12">
	                                  <div class="form-group">
	                                      <label>Generate Date <span class="text-danger">*</span></label>
	                                      <div class="cal-icon">
	                                          <input type="text" name="generate_date" class="form-control date-picker" required="required" placeholder="yyyy-mm-dd" id="id-date-picker-1" data-date-format="yyyy-mm-dd">
	                                      </div>
	                                  </div>
	                                </div>
