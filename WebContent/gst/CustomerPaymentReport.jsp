       ...
       <%@ include file="../footer.jsp" %>
	    ...
	    $("form").submit(function(e){
	        ...
	        if(report_type=='date'){
	        	...
	        	window.location="CustomerPaymentReport.jsp?action=generateReport&business_id="+business_id+"&report_type="+report_type+"&from_date="+from_date+"&to_date="+to_date+"&plant_id="+plant_id;
	        }else if(report_type=='customer'){
	        	var customer_id=$('#customer_id').val();
	        	var site_id=$('#site_id').val();
	        	var product_id=$('#product_id').val();
	        	var plant_id=$('#plant_id').val();
	        	window.location="CustomerPaymentReport.jsp?action=generateReport&business_id="+business_id+"&report_type="+report_type+"&customer_id="+customer_id+"&site_id="+site_id+"&product_id="+product_id+"&plant_id="+plant_id;
	        }
	        	...
	        	var from_date=$('input[name="from_date"]').val();
	        	var to_date=$('input[name="to_date"]').val();
	        	window.location="CustomerPaymentReport.jsp?action=generateReport&business_id="+business_id+"&report_type="+report_type+"&customer_id="+customer_id+"&from_date="+from_date+"&to_date="+to_date+"&plant_id="+plant_id;
	        }
	    });
    </script>
