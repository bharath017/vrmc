...
<head>
        <meta charset="utf-8" />
        <title>Sales Comission List</title>
       ...
       <%@ include file="../header.jsp" %>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Sales Comission List</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Sales Comission List</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="AddSalesComission.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add Sales Comission</a>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                                ...
                                <sql:query var="payment" dataSource="jdbc/rmc">
                                	select p.*,c.customer_name from test_sales_comission p left join test_customer c on p.customer_id=c.customer_id where p.customer_id like if(''=?,'%%',?) and payment_id like if(''=?,'%%',?)  order by payment_id desc limit 500
                                ...
                                <c:forEach items="${payment.rows}" var="payment">
                                   	<tr>
                                        ...
                                        <td class="text-center">
                                        	CHECK/DD NO : ${payment.check_dd_no}<br>
                                        	CHECK/DD VALIDITY : ${payment.check_dd_validity}
                                        </td>
                                        <td class="text-center">
	                                            ...
	                                            <a href="javascript: void(0);" class="table-action-btn dropdown-toggle arrow-none btn btn-light btn-sm" data-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-dots-horizontal"></i></a>
	                                            	<div class="dropdown-menu dropdown-menu-right">
		                                            	<%-- <a class="dropdown-item" href="PaymentReceipt.jsp?payment_id=${payment.payment_id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Print Receipt</a> --%>
		                                           	    <a class="dropdown-item" href="AddSalesComission.jsp?action=update&payment_id=${payment.payment_id}"><i class="fa fa-edit mr-2 text-muted font-18 vertical-middle"></i>Edit Payment</a>
		                                                <a class="dropdown-item" href="#dele-model" data-animation="blur" data-plugin="custommodal" onclick="deletePayment('${payment.payment_id}');" data-overlaySpeed="100" data-overlayColor="#36404a"><i class="mdi mdi-window-close mr-2 text-muted font-18 vertical-middle"></i>Delete Payment</a>
		                                            </div>
	                                        </div>
										</td>
                                    </tr>
				...
				<div id="dele-model" class="modal-demo col-xs-2">
		            ...
		            <h4 class="custom-modal-title" style="color: white;background-color: #9b3329;">Are you sure want to delete payment Id : <span class="payment_id"></span>?</h4>
		            <div class="custom-modal-text">
		                <form class="form-horizontal" action="../TestSalesComissionController?action=DeletePayment" method="post">
		                	<input type="hidden" name="payment_id" id="payment_id" class="payment_id"/>
		  ...
		  <script type="text/javascript">
		    $(document).ready(function(){
		    	$('#search').on('click',function(){
		    		...
		    		window.location='SalesComissionList.jsp?customer_id='+customer_id+'&payment_id='+payment_id;
		    	});
		    });
	     </script>
