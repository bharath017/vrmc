			                           		...
			                           		<div class="col-sm-3 table-responsive">
			                           			<table class="table table-bordered">
			                           				...
			                           				<sql:query var="contact" dataSource="jdbc/rmc">
			                           					select * from test_customer_contact_person where customer_id=?
			                           					<sql:param value="${rs.customer_id}"/>
			                           				</sql:query>
			                           				<tbody>
			                           					<c:forEach var="contact" items="${contact.rows}">
			                           					<tr class="${(addr.site_status=='inactive')?'text-danger':''}">
			                           						<td>${contact.contact_name}</td>
			                           						<td>${contact.phone}</td>
			                           						<td>
			                           							<a href="#contact-delete" data-animation="blur" onclick="deleteContactDetails('${contact.contact_id}','${contact.contact_name}');" data-plugin="custommodal" data-overlaySpeed="100" data-overlayColor="#36404a" class="btn btn-icon waves-effect waves-light btn-danger">
			                           								<i class="fa fa-window-close"></i>
			                           							</a>
			                           						</td>
			                           					</tr>
                      ...
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" action="../CustomerViewControllerTest?action=addSiteDetails" method="post">
                      ...
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" action="../CustomerViewControllerTest?action=updateSiteDetails" method="post">
                  ...
                  <!-- Address Deactivate Model Details  -->
					<div id="delete-model" class="modal-demo col-xs-2">
			            ...
			            <div class="custom-modal-text">
			                <form class="form-horizontal" action="../CustomerViewControllerTest?action=changeSiteStatus" method="post">
				...
				<div id="add-contact"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" style="display: none;">
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" action="../CustomerViewControllerTest?action=InsertContactPerson" method="post">
				  ...
				  <!-- Delete Contact Model details..  -->
					<div id="contact-delete" class="modal-demo col-xs-2">
			            ...
			            <div class="custom-modal-text">
			                <form class="form-horizontal" action="../CustomerViewControllerTest?action=DeleteContactPerson" method="post">
					...
					<div id="project_block" class="modal-demo col-xs-2">
			            ...
			            <div class="custom-modal-text">
			                ...
			                <form class="form-horizontal" action="../CustomerControllerTest?action=insertProjectBlock" method="post">
