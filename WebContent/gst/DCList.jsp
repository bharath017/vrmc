...
<head>
		...
		<link rel="stylesheet" href="../assets/css2/render.css">
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
								...
								<sql:query var="invoice" dataSource="jdbc/rmc">
									...
									from test_dc i LEFT JOIN (test_customer c,test_site_detail s,test_purchase_order_item poi,product p,plant pl)
											 ...
											 <div class="btn-group dropdown">
	                                            ...
	                                            <div class="dropdown-menu dropdown-menu-right">
	                                            	...
	                                            	<c:if test="${invoice.invoice_status=='active'}">
		                                            	<a class="dropdown-item" target="_blank" href="PrintDC.jsp?id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Print DC</a>
														...
														<a class="dropdown-item" href="../DCControllerTest?action=DownloadBatchSheet&id=${invoice.id}&class=BCMConcrete"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Download Batch Report</a>
...
<%-- 		                                            	<a class="dropdown-item" href="DCController?action=DownloadBatchSheet2&id=${invoice.id}&class=BCMConcrete"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Download Batch Report</a> --%>
		                                           	    ...
		                                           	    <a class="dropdown-item" href="../DCControllerTest?action=RefreshDC&id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Refresh DC</a>
                      ...
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" name="update_vehicle" action="../DCControllerTest?action=UpdateVehicle" method="post">
				...
				<div id="delete-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" action="../DCControllerTest?action=UpdateDateTime" method="post">
		                	<div class="form-group">
				...
				<div id="cancel-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="../DCControllerTest?action=CancelInvoice">
				...
				<div id="docket_modal" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="../DCControllerTest?action=ChangeDocketNo">
				...
				<div id="deleteinvoice-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="../DCControllerTest?action=DeleteInvoice">
