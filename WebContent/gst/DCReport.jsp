    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                	<div class="col-md-12">
                		<h2 class="text-info text-center">Generate Invoice Report</h2><hr><br><br>
                	</div>
                    <div class="col-md-12">
               				...
               				<c:choose>
               					<c:when test="${param.report_type=='date'}">
               						<sql:query var="inv" dataSource="jdbc/rmc">
               						    ...
               						    from test_dc i LEFT JOIN (test_customer c,test_site_detail s,test_purchase_order_item poi,product pr,plant p,test_purchase_order po,marketing_person m)
			               				...
			               				<tr style="background-color: #4b9663;color: white;">
			               					...
			               					<c:catch var="ee">
			               						<sql:query var="customer" dataSource="jdbc/rmc">
				               						...
				               						from test_dc i LEFT JOIN(test_customer c,test_purchase_order_item poi)
				               						ON i.customer_id=c.customer_id 
				               						and i.poi_id=poi.poi_id
				               						where i.customer_id like if(0=?,'%%',?)
													and i.site_id like if(''=?,'%%',?)
				               				...
				               				<c:forEach var="customer" items="${customer.rows}">
				               					<c:catch var="er">
				               						<sql:query var="invv" dataSource="jdbc/rmc">
				               							...
				               							i.quantity,i.net_amount,p.product_name,i.rate,i.gross_amount,pl.plant_name,i.vehicle_no
														from test_dc i LEFT JOIN(test_customer c,test_site_detail s,product p,test_purchase_order_item poi,plant pl)
														ON i.customer_id=c.customer_id 
														and i.site_id=s.site_id 
														and i.poi_id=poi.poi_id 
														and poi.product_id=p.product_id
       ...
       <%@ include file="../footer.jsp" %>
	    ...
	    $("#myform").submit(function(e){
	        ...
	        if(report_type=='date'){
	        	...
	        	var product_id=$('#product_id').val();
	        	var plant_id=$('#plant_id').val();
	        	window.location="DCReport.jsp?action=generateReport&report_type="+report_type+"&from_date="+from_date+"&to_date="+to_date+"&vehicle_no="+vehicle_no+"&product_id="+product_id+"&plant_id="+plant_id+"&block_name="+block_name;
