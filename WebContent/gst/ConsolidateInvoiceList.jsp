                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
								...
								<sql:query var="invoice" dataSource="jdbc/rmc">
									...
									(select sum(i.quantity) from test_invoice i,test_consolidate_invoice_item ci where i.id=ci.id and ci.consolidate_invoice_id=c.consolidate_invoice_id) as net_quantity,
									(select sum(i.net_amount) from test_invoice i,test_consolidate_invoice_item ci where i.id=ci.id and ci.consolidate_invoice_id=c.consolidate_invoice_id) as net_amount
									from test_consolidate_invoice c,test_customer cu where c.customer_id=cu.customer_id and   consolidate_invoice_id like if(''=?,'%%',?) and c.customer_id like if(''=?,'%%',?)
