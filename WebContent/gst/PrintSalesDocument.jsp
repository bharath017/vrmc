...
<body>
	<div class="container">
			...
			<sql:query var="sales" dataSource="jdbc/rmc">
				...
				from test_sales_document s ,test_customer c, test_site_detail st,plant pl
			...
			<table class="table table-condensed"  style="width: 100%">
				...
				<tr>
					<td class="text-center" colspan="8">
							...
							<div class="col-xs-8">
								...
								<p style="font-size: 1.2em;margin-bottom: 0px;">${rs.plant_address}<br>
								     ${rs.plant_phones}<br>
				...
				<sql:query var="sdi" dataSource="jdbc/rmc">
					...
					from test_sales_document_item s LEFT JOIN(test_purchase_order_item poi,product p,test_purchase_order po,gst_percent g)
				...
				<tr class="text-center">
					...
					<td colspan="2" class="text-right">${sdi.gross_price}</td>
				</tr>
				</c:forEach>
				<tr>
				...
				<tr>
					...
					<td colspan="4"><b>Vehicle No : </b>${invoice.vehicle_no}</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="8" class="text-center">Registered Office : SY NO 53/37, SAVAKANAHALLI VILLAGE, KASABA HOBLI, DEVANAHALL TALUK, BANGALORE RURAL - 562110</td>
				</tr>
			</table>
