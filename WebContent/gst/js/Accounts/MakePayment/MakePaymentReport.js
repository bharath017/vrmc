	 ...
	 $('.date-picker').datepicker({
	  ...
	  //click to generate report
		...
		let getDateWiseReport= (from_date,to_date,business_id) => {
			...
			$.ajax({
				type:'post',
				url:'../MakePaymentControllerTest?action=getDateWiseReport&from_date='+from_date+'&to_date='+to_date+'&business_id='+business_id,
				headers:{
					Accept:"application/json;charset=utf-8",
					"Content-Type":"application/json;charset=utf-8"
				},
		...
		let getSupplierWiseReport= (supplier_id,supplier_name,business_id) => {
			...
			$.ajax({
				type:'post',
				url:'../MakePaymentControllerTest?action=getSupplierWiseReport&supplier_id='+supplier_id+'&business_id='+business_id,
				headers:{
					Accept:"application/json;charset=utf-8",
					"Content-Type":"application/json;charset=utf-8"
				},
		...
		let getSupplierWithDateWiseReport= (supplier_id,supplier_name,from_date,to_date,business_id) => {
			...
			$.ajax({
				type:'post',
				url:'../MakePaymentControllerTest?action=getSupplierWithDateWise&supplier_id='
		...
		let getTransactionReport= (from_date,to_date,business_id) => {
			...
			$.ajax({
				type:'post',
				url:'../MakePaymentControllerTest?action=getPurchaseTransaction&business_id='+business_id+'&from_date='+from_date+'&to_date='+to_date,
				headers:{
					Accept:"application/json;charset=utf-8",
					"Content-Type":"application/json;charset=utf-8"
				},
