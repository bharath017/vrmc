        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <c:choose>
              	<c:when test="${param.action=='update'}">
              		<sql:query var="inv" dataSource="jdbc/rmc">
              			select * from test_inventory where inventory_id=?
                 ...
                 <c:forEach items="${inv.rows}" var="invento">
              	...
              	<div class="row">
                    <div class="col-sm-12">
                    	<form class="" id="myform" action="../InventoryControllerTest?action=UpdateInventory" method="post">
      		...
      		<c:otherwise>
              	<div class="row">
                    <div class="col-sm-12">
                    	<form class="" id="myform" action="../InventoryControllerTest?action=InsertInventory" method="post">
	                        <div class="card-box row col-sm-12">
	                           	<div class="col-sm-6">
	                           		<div class="form-group">
	                                    <label>Plant <span class="text-danger">*</span></label>
	                                ...
	                                <div class="form-group">
                                        ...
                                        <div>
                                            <div class="input-group">
                                            	<input type="hidden" readonly="readonly"  class="form-control"  name="inventory_document" id="inventory_document"/>
                                                <input type="file" class="form-control"  class="find" id="id-input-file-1" accept="application/pdf,application/vnd.ms-excel"/>
                                                <div class="input-group-append">
                                                    <button type="button" id="uploadBtn" class="input-group-text bg-custom text-white">Click here to upload</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
				...
				<div id="cancel-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="../InventoryControllerTest?action=InsertInventoryVehicle">
		                	<div class="form-group">
                      ...
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" name="update_vehicle" action="../InventoryControllerTest?action=UpdateLoadedWeight" method="post">
  ...
  <script type="text/javascript">
  		$(document).ready(function(){
  			$('#vehicle_no').on('change',function(){
  				...
  				$.ajax({
  	  				type:'POST',
  	  				url:'../InventoryControllerTest?action=GetLoadedWeight&vehicle_no='+vehicle_no,
  	  				headers:{
  ...
  <script type="text/javascript">
  		$(document).ready(function(){
  			$('#inv_item_id').on('change',function(){
  				...
  				$.ajax({
  					type:'post',
  					url:'../InventoryControllerTest?action=getUnit&inv_item_id='+inv_item_id,
  					headers:{
  		...
  		$('#uploadBtn').on('click',function(){
			if($('#id-input-file-1').val()){
				var data = new FormData();
		   		 ...
		   		 $.ajax({
		   			    url: '../InventoryControllerTest?action=uploadInventoryDocument',
					    data: data,
					    cache: false,
					    contentType: false,
					    processData: false,
					    ...
					    success:function(res){
					    	$('#viewPreview').attr('href','image/inventory/'+res);
					    	$('#inventory_document').val(res);
