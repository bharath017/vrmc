...
<head>
        <meta charset="utf-8" />
        <title>Petty Cash Transaction Report</title>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Petty Cash Transaction Report</h4>
                        </div>
                    </div>
                </div>
                 <!-- end row -->
                          ...
                          <div class="row">
                          	<div class="form-group col-sm-2">
                          		...
                          		<select class="form-control" id="report_type">
                          			...
                          			<option value="at">Account Transaction</option>
                          		</select>
                          	</div>
       ...
       <%@ include file="../footer.jsp" %>
        ...
        <script type="text/javascript" src="js/Accounts/PettyCash/PettyCashTransactionReport.js"></script>
