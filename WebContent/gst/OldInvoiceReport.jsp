    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Old Invoice Report</a></li>
                                </ol>
                            </div>
                            <h4 class="page-title">Old Invoice Report</h4>
                        </div>
                    </div>
                </div>
                 <!-- end row -->
                <div class="row">
                	<div class="col-md-12">
                		<h2 class="text-info text-center">Generate Old Invoice Report</h2><hr><br><br>
                	</div>
                    <div class="col-md-12">
                ...
                <form action="../InvoiceControllerTest?action=generatecons" method="post" class="form" id="myfrm" style="margin: 0 !important;padding: 0 !important;">
               				...
               				<c:choose>
               					<c:when test="${param.report_type=='date'}">
               						<sql:query var="inv" dataSource="jdbc/rmc">
               						    ...
               						    from test_invoice_report i LEFT JOIN (test_customer c,test_site_detail s,test_purchase_order_item poi,product pr,plant p,test_purchase_order po,marketing_person m)
			               				...
			               				<tr style="background-color: #4b9663;color: white;">
			               					...
			               					<c:catch var="ee">
			               						<sql:query var="customer" dataSource="jdbc/rmc">
				               						...
				               						from test_invoice_report i LEFT JOIN(test_customer c,test_purchase_order_item poi)
				               						ON i.customer_id=c.customer_id 
				               						and i.poi_id=poi.poi_id
				               						where i.customer_id like if(0=?,'%%',?)
													and i.site_id like if(''=?,'%%',?)
				               				...
				               				<c:forEach var="customer" items="${customer.rows}">
				               					<c:catch var="er">
				               						<sql:query var="invv" dataSource="jdbc/rmc">
				               							...
				               							i.quantity,i.net_amount,p.product_name,i.rate,i.gross_amount,pl.plant_name,i.vehicle_no
														from test_invoice_report i LEFT JOIN(test_customer c,test_site_detail s,product p,test_purchase_order_item poi,plant pl)
														ON i.customer_id=c.customer_id 
														and i.site_id=s.site_id 
														and i.poi_id=poi.poi_id 
														and poi.product_id=p.product_id
         ...
         <!-- Modal for tally ladger save  -->
				...
				<div id="tally_modal" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" action="../InvoiceControllerTest?action=UpdateTallyLedger" method="post">
