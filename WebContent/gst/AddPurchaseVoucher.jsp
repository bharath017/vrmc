            ...
            <div class="container-fluid">
                ...
                <c:choose>
                	<c:when test="${param.action=='update'}">
                		...
                		<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" action="../PurchaseVoucherControllerTest?action=UpdatePurchasevoucher" method="post">
		                                	...
		                                	<table class="table table-bordered" id="Table1">
		                                		<thead>
		                                		 ...
		                                		 <sql:query var="poi" dataSource="jdbc/rmc">
	                                            	select * from test_purchase_voucher_item  where purchase_voucher_id=?
                	...
                	<c:otherwise>
                		<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" action="../PurchaseVoucherControllerTest?action=InsertVoucher" method="post">
			                        <div class="card-box row col-sm-12">
			                           	<div class="col-sm-6">
			                           	   <div class="form-group">
			                                    <label>Bill No : </label>
