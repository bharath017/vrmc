...
<head>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Bank Transaction Report</h4>
                        </div>
                    </div>
                </div>
                 <!-- end row -->
                       ...
                       <form action="#" id="myform"
                          ...
                          <div class="row">
                           ...
                           <div class="form-group col-sm-2 date">
                               ...
                               <select class="form-control date" name="bank_detail_id" id="bank_detail_id">
       ...
       <%@ include file="footer.jsp" %>
        ...
        <script type="text/javascript" src="js/Accounts/Bank/BankTransactionReport.js"></script>
