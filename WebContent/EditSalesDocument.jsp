        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <sql:query var="sale" dataSource="jdbc/rmc">
                	select id,invoice_id,DATE_FORMAT(invoice_date,'%d/%m/%Y') as invoice_date,invoice_time,
                	s.customer_id,s.site_id,vehicle_no,driver_name,st.site_address,s.tcs_percent,s.round_off
                    from sales_document s,site_detail st
                ...
                <!-- end row -->
               		<div class="row">
	                    <div class="col-sm-12">
	                    	<form class="" action="SalesDocumentController?action=updateSalesDocument" method="post" id="sales-document-form">
		                        <div class="card-box row col-sm-12">
		                                ...
		                                <div class="form-group">
                                         ...
                                         <div class="form-group">
                                               ...
                                               <div>
                                                   ...
                                                   <input type="hidden" name="documents" value="${rs.documents}"/>
                                               </div>
                                         </div>
		                            </div>
		                            <div class="col-sm-4">
		                             ...
		                             <div class="col-sm-4">
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <div class="checkbox checkbox-custom">
	                                            <input id="checkbox11" name="tcs_applicable"
	                                            	 type="checkbox" ${(rs.tcs_percent>0)?'checked':''}>
		                             ...
		                             <div class="col-sm-12" id="clicked">
	                                	<table class="table table-bordered" id="Table1">
	                                		...
	                                		<sql:query var="sitem" dataSource="jdbc/rmc">
	                                			select si.poi_id,si.sditem_id,si.id,si.item_quantity,si.item_price,si.tcs_price,
	                                			si.gross_price,si.tax_price,si.net_price,p.product_name,g.gst_percent,g.gst_category,po.rate_include_tax
	                                			from sales_document_item si LEFT JOIN (purchase_order_item poi,product p,purchase_order po,gst_percent g)
		                                			...
		                                			<tr>
		                                				...
		                                				<td>
		                                					<input type="text" class="form-control tcs_amount" title="tcs_amount"  readonly="readonly"
		                                							 pattern="[^\'&quot;:]*$"  required="required"   name="tcs_amount[${vall}]" value="${sitem.tcs_price}"/>
		                                				</td>
		                                				<td>
	                                		...
	                                		<tfoot>
	                                			...
	                                			<tr>
	                                				<td colspan="6" class="text-right">TCS @ <span id="tcs_percent">${rs.tcs_percent}  </span> %</td>
	                                				<td class="text-left" colspan="2" id="tcs_amount">${rs.tcs_amount}</td>
	                                			</tr>
	                                			<tr>
	                                				<td colspan="6" class="text-right">Round Off </td>
	                                				<td class="text-left" colspan="2" id="round_off">${rs.round_off}</td>
	                                			</tr>
	                                			<tr>
	                                ...
	                                <input  type="hidden" name="tcs_percent" value="${rs.tcs_percent}"/>
	                                <input type="hidden" name="round_off" value="${rs.round_off}"/>
