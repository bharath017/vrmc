                ...
                <c:choose>
                	<c:when test="${param.action=='update'}">
                		<sql:query var="po" dataSource="jdbc/rmc">
                			...
                			s.site_address from purchase_order p,site_detail s where p.site_id=s.site_id and  p.order_id=?
                		...
                		<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" action="PurchaseOrderController?action=UpdatePurchaseOrder" method="post">
			                               ...
			                               <div class="form-group">
			                                ...
			                                <div class="form-group">
			                                    ...
			                                    <sql:query var="market" dataSource="jdbc/rmc">
			                                        ...
			                                        where mp_status='active'  order by mp_name asc
			                                    </sql:query>
			                                ...
			                                <div class="form-group">
			                                	 <label>&nbsp;</label>
			                                    <div class="checkbox checkbox-custom">
		                                            <input id="checkbox12" name="tcs_required" ${(res.tcs_required==true)?'checked':''} type="checkbox"/>
                	...
                	<c:otherwise>
                		<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" action="PurchaseOrderController?action=insert" method="post">
			                        <div class="card-box row col-sm-12">
			                           	<div class="col-sm-6">
			                           	   <div class="form-group">
			                                    <label>Customer <span class="text-danger">*</span></label>
			                            ...
			                            <div class="col-sm-6">
			                               <div class="form-group">
			                                ...
			                                <div class="form-group">
			                                	 <label>&nbsp;</label>
			                                    <div class="checkbox checkbox-custom">
		                                            <input id="checkbox12" name="tcs_required" type="checkbox"/>
		                                            <label for="checkbox12">
		                                                TCS Required ?
		                                            </label>
		                                        </div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				var getMarketingPersonDetails=function(customer_id){
					$.ajax({
						type:'post',
						url:'CustomerController?action=getCustomerMarketingPerson&customer_id='+customer_id,
						headers:{
							Accept:'application/json;charset=utf-8',
							'Content-Type':'application/json;charset=utf-8'
						},
