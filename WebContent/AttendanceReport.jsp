...
<head>
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                          ...
                          <div class="row">
                          	<div class="form-group col-sm-2">
                          		...
                          		<select class="form-control" id="report_type">
                          			<option value="date">Employee With Date Wise Report</option>
                          	...
                          	<div class="form-group col-sm-2 date">
                                ...
                                <div>
                                    <div class="input-group">
                                        <input type="text" name="from_date" class="form-control date-picker from_date date"
                           ...
                           <div class="form-group col-sm-2 date">
                                ...
                                <div>
                                    <div class="input-group">
                                        <input type="text" name="to_date" class="form-control date-picker to_date date"
                           ...
                           <div class="form-group col-sm-2 date">
                          		<label for="report_type">Employee <span class="text-danger">*</span></label>
                          		<sql:query var="employee" dataSource="jdbc/rmc">
	                          		select e_id,employee_id,employee_name
	                          		from employee 
								...
								<select class="form-control date" id="e_id" name="e_id">
                          			<c:forEach items="${employee.rows}" var="rs">
                          				<option value="${rs.e_id}">${rs.employee_name} - ${rs.employee_id}</option>
                          			</c:forEach>
                          		</select>
                          	</div>
                           <div class="form-group col-sm-2">
                ...
                <div class="row card">
                	...
                	<div class="col-sm-12 text-center result table-responsive" id="report-place">
       ...
       <%@ include file="footer.jsp" %>
        ...
        <script type="text/javascript" src="js/hrm/AttendanceReport.js"></script>
