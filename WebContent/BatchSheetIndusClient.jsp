...
<c:choose>
  ...
  <!-- Get all the moisture details here -->
  
  <sql:query var="moi" dataSource="jdbc/rmc">
  	select DISTINCT round(agg1_moi,2) as agg1_moi,round(agg2_moi,2) as agg2_moi,round(agg3_moi,2) as agg3_moi,round(agg4_moi,2) as agg4_moi,agg1_abs,agg2_abs,agg3_abs,agg4_abs
  	from batchingsheet
  	where id=?
  	<sql:param value="${param.id}"/>
  </sql:query>
  ...
  <c:forEach items="${moi.rows}" var="moi">
  	<c:set var="mo" value="${moi}"/>
  </c:forEach> 
...
<table width="27PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13"  ALIGN="RIGHT"><fmt:formatNumber value="${rec.g1-((mo.agg1_abs*(rec.g1/100))-(mo.agg1_moi*(rec.g1/100)))}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:120PX; top:275PX; width:32PX; height:15PX; " class="adornment10"  ALIGN="RIGHT">
<table width="27PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13"  ALIGN="RIGHT"><fmt:formatNumber value="${rec.g2-((mo.agg2_abs*(rec.g2/100))-(mo.agg2_moi*(rec.g2/100)))}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:160PX; top:275PX; width:32PX; height:15PX; " class="adornment10"  ALIGN="RIGHT">
<table width="27PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13"  ALIGN="RIGHT"><fmt:formatNumber value="${rec.g3-((mo.agg3_abs*(rec.g3/100))-(mo.agg3_moi*(rec.g3/100)))}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:208PX; top:275PX; width:32PX; height:15PX; " class="adornment10"  ALIGN="RIGHT">
<table width="27PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13"  ALIGN="RIGHT"><fmt:formatNumber value="${rec.g4-((mo.agg4_abs*(rec.g4/100))-(mo.agg4_moi*(rec.g4/100)))}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>
...
<table width="29PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13"  ALIGN="RIGHT"><fmt:formatNumber value="${rec.g8+((mo.agg1_abs*(rec.g1/100))-(mo.agg1_moi*(rec.g1/100)))+((mo.agg2_abs*(rec.g2/100))-(mo.agg2_moi*(rec.g2/100)))+((mo.agg3_abs*(rec.g3/100))-(mo.agg3_moi*(rec.g3/100)))+((mo.agg4_abs*(rec.g4/100))-(mo.agg4_moi*(rec.g4/100)))}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>
...
<table width="27PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor110"  ALIGN="RIGHT"><fmt:formatNumber value="${rec.aggregate1_value*rec.p_quantity}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:160PX; top:${top1+28}PX; width:30PX; height:14PX; " class="adornment10"  ALIGN="RIGHT">
<table width="25PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor110"  ALIGN="RIGHT"><fmt:formatNumber value="${(rec.aggregate3_value-((mo.agg3_abs*(rec.aggregate3_value/100))-(mo.agg3_moi*(rec.aggregate3_value/100))))}" maxFractionDigits="0" var="aa3"  groupingUsed="false"/><fmt:formatNumber value="${aa3*rec.p_quantity}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:200PX; top:${top1+28}PX; width:30PX; height:14PX; " class="adornment10"  ALIGN="RIGHT">
<table width="25PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor110"  ALIGN="RIGHT"><fmt:formatNumber value="${(rec.aggregate4_value-((mo.agg4_abs*(rec.aggregate4_value/100))-(mo.agg4_moi*(rec.aggregate4_value/100))))}" maxFractionDigits="0" var="aa4"  groupingUsed="false"/><fmt:formatNumber value="${aa4*rec.p_quantity}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:115PX; top:${top1+28}PX; width:32PX; height:14PX; " class="adornment10"  ALIGN="RIGHT">
<table width="27PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor110"  ALIGN="RIGHT"><fmt:formatNumber value="${(rec.aggregate2_value-((mo.agg2_abs*(rec.aggregate2_value/100))-(mo.agg2_moi*(rec.aggregate2_value/100))))}" maxFractionDigits="0" var="aa2"  groupingUsed="false"/><fmt:formatNumber value="${aa2*rec.p_quantity}" maxFractionDigits="0" groupingUsed="false"/></td></tr></table>
</DIV>
...
<table width="53PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13" >${mo.agg1_moi}</td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:128PX; top:${top1+76}PX; width:58PX; height:15PX; " class="adornment10" >
<table width="53PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13" >${mo.agg2_moi}</td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:168PX; top:${top1+76}PX; width:58PX; height:15PX; " class="adornment10" >
<table width="53PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13" >${mo.agg3_moi}</td></tr></table>
</DIV>

<DIV  style="z-index:25; position:absolute; left:216PX; top:${top1+76}PX; width:58PX; height:15PX; " class="adornment10" >
<table width="53PX" border=0 cellpadding="0" cellspacing="0"><tr><td NOWRAP class="fontColor13" >${mo.agg4_moi}</td></tr></table>
</DIV>
<BR>
</c:when>
<c:otherwise>
