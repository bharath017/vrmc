        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <!-- end row -->
              	...
              	<div class="row">
                    <div class="col-sm-12">
                    	<form class="" id="myform" action="InvoiceController?action=InsertInvoice"  method="post">
	                        <div class="card-box row col-sm-12">
	                           	<div class="col-sm-6">
	                           	   ...
	                           	   <div class="form-group">
										...
										<label id="customer-error" class="error" hidden for="customer"></label>
	                                </div>
	                                ...
	                                <div class="form-group">
										...
										<label id="site_id-error" class="error" hidden for="site_id"></label>
	                                </div>
	                                ...
	                                <div class="form-group">
										...
										<label id="poi_id-error" hidden class="error" for="poi_id"></label>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div>
	                                       <input type="text" class="form-control" 
	                                         pattern="[^'&quot;:]*$"   required="required"  id="quantity" name="quantity"/>
	                                    </div>
	                                </div>
	                                <div class="form-group">
	                            ...
	                            <div class="col-sm-6">
	                              <div class="form-group">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div>
	                                        <div class="input-group">
	                                            <input type="text" name="invoice_time" class="form-control" required="required"
	                                ...
	                                <div class="form-group">
										...
										<label id="vehicle_no-error" class="error" hidden for="vehicle_no"></label>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div>
	                                       <input type="number" class="form-control" 
	                                          step="0.01"     id="km_reading" name="km_reading"/>
	                                    </div>
	                                </div>
								  ...
								  <!-- write all hidden data here -->
		                          	...
		                          	<input type="hidden" name="tcs_price" id="tcs_price"/>
                                	...
                                	<table class="table table-bordered" id="Table1">
                                		...
                                		<tbody>
	                                		...
	                                		<tr>
	                                			...
	                                			<td class="nochange" style="width: 16.66%" id="tcs_view"></td>
	                                			<td class="change" style="width: 16.66%">Balance Quantity : </td>
