                ...
                <div class="row text-center">
                    <div class="col-xs-6 col-sm-3 text-center" >
                        <div class="card-box widget-flat  text-white" style="background-color: #c630f0;border-color:#c630f0;">
                            ...
                            <p class="text-uppercase m-b-5 font-13 font-600">Today Production</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <div class="card-box widget-flat text-white" style="background-color: #c630f0;border-color:#c630f0;">
                            ...
                            <p class="text-uppercase m-b-5 font-13 font-600">Tomorrow Production</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <div class="card-box widget-flat text-white" style="background-color: #c630f0;border-color:#c630f0;">
                            ...
                            <p class="text-uppercase m-b-5 font-13 font-600">This Week Production</p>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <div class="card-box widget-flat text-white" style="background-color: #c630f0;border-color:#c630f0;">
                            <i class=" fa fa-money"></i>
                            <h5 class="m-b-10" id="thismonth"></h5>
                            <p class="text-uppercase m-b-5 font-13 font-600">PENDING SCHEDULING</p>
                        </div>
                    </div>
				</div>
				<form id="clear-form">
