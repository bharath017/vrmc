       ...
       <%@ include file="header.jsp" %>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">DC List</li>
                                </ol>
                            </div>
                            <h4 class="page-title">DC List</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="AddDC.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add DC</a>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
                            ...
                            <table id="example" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                                <thead>
	                                <tr>
										...
										<th class="text-center">DC Quantity</th>
										<th class="text-center">Loaded Quantity</th>
								...
								<sql:query var="invoice" dataSource="jdbc/rmc">
									...
									from dc i LEFT JOIN (customer c,site_detail s,purchase_order_item poi,product p,plant pl)
                                ...
                                <c:forEach var="invoice" items="${invoice.rows}">
									<tr class="${(invoice.invoice_status=='cancelled')?'text-danger':''}">
										...
										<td class="text-center">${invoice.loaded_quantity}</td>
											 ...
											 <div class="btn-group dropdown">
	                                            ...
	                                            <div class="dropdown-menu dropdown-menu-right">
	                                            	...
	                                            	<c:if test="${invoice.invoice_status=='active'}">
		                                            	<a class="dropdown-item" target="_blank" href="PrintInvoice.jsp?id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Print DC</a>

														<a class="dropdown-item" href="PrintDC2.jsp?id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Print Load Copy</a>
														
														<a class="dropdown-item" href="DCController?action=DownloadBatchSheet&id=${invoice.id}&class=BCMConcrete"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Download Batch Report</a>
															<c:if test="${invoice.sd_no==null}">
														<a class="dropdown-item" href="#generateinvoice-model" data-animation="blur" data-plugin="custommodal" onclick="genInv('${invoice.id}');" data-overlaySpeed="100" data-overlayColor="#36404a"><i class="fa fa-calendar mr-2 text-muted font-18 vertical-middle"></i>Generate Invoice</a>
														</c:if>
<%-- 		                                            	<a class="dropdown-item" href="DCController?action=DownloadBatchSheet2&id=${invoice.id}&class=BCMConcrete"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Download Batch Report</a> --%>
		                                           	    ...
		                                           	    <a class="dropdown-item" href="#docket_modal" data-animation="blur" data-plugin="custommodal" onclick="changeDocketNo('${invoice.id}','${invoice.invoice_id}');" data-overlaySpeed="100" data-overlayColor="#36404a"><i class="fa fa-dashcube mr-2 text-muted font-18 vertical-middle"></i>Edit Docket</a>
		                                           	     ...
		                                           	     <a class="dropdown-item" href="EditDC.jsp?id=${invoice.id}"><i class="fa fa-edit mr-2 text-muted font-18 vertical-middle"></i>Edit DC</a>
		                                           	    
		                                           	    <a class="dropdown-item" href="DCController?action=RefreshDC&id=${invoice.id}"><i class="fa fa-print mr-2 text-muted font-18 vertical-middle"></i>Refresh DC</a>
		                                                
		                                                <a class="dropdown-item" href="#cancel-model" data-animation="blur" data-plugin="custommodal" onclick="cancelInvoice('${invoice.id}','${invoice.invoice_id}')" data-overlaySpeed="100" data-overlayColor="#36404a"><i class="mdi mdi-window-close mr-2 text-muted font-18 vertical-middle"></i>Cancel DC</a>
		                                                <a class="dropdown-item" href="#deleteinvoice-model" data-animation="blur" data-plugin="custommodal" onclick="deleteInvoice('${invoice.id}','${invoice.invoice_id}')" data-overlaySpeed="100" data-overlayColor="#36404a"><i class="fa fa-trash mr-2 text-muted font-18 vertical-middle"></i>Delete DC</a>
	                                            	</c:if>
	                                            </div>
	                                        </div>
										</td>
                      ...
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" name="update_vehicle" action="DCController?action=UpdateVehicle" method="post">
				...
				<div id="delete-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" action="DCController?action=UpdateDateTime" method="post">
		                	<div class="form-group">
                                  <label class="pull-left">DC Date <span class="text-danger">*</span> </label>
                                  <div>
                                      <div class="input-group">
                             ...
                             <div class="form-group">
                                  <label class="pull-left">DC Time <span class="text-danger">*</span> </label>
                                  <div>
                                      <div class="input-group">
				...
				<div id="cancel-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="DCController?action=CancelInvoice">
				...
				<div id="docket_modal" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="DCController?action=ChangeDocketNo">
				...
				<div id="deleteinvoice-model" class="modal-demo col-xs-2">
		            ...
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="DCController?action=DeleteInvoice">
				...
				<div id="generateinvoice-model" class="modal-demo col-xs-2">
		            <button type="button" class="close" onclick="Custombox.close();">
		                <span>&times;</span><span class="sr-only">Close</span>
		            </button>
		            <h4 class="custom-modal-title" style="color: white;background-color: #491136;">Are you sure want to Generate Invoice : <span class="invoice_id_delete"></span> </h4>
		            <div class="custom-modal-text">
		                <form class="form-horizontal" method="post" action="SalesDocumentController?action=generateInvoiceFromDC">
		                	<input type="hidden" name="dc_id" id="dc_id_gen"/>
		                	
		                    <div class="form-group account-btn text-center m-t-2">
		                        <div class="col-12">
		                            <button class="btn w-lg btn-rounded btn-custom waves-effect waves-light" type="submit">GENERATE INVOICE</button>
		                            <button class="btn w-lg btn-rounded btn-custom btn-danger waves-effect waves-light"  onclick="Custombox.close();" type="button">CLOSE</button>
		                        </div>
		                    </div>
		                </form>
	    ...
	    $(document).ready(function(){
	    	$('#search').on('click',function(){
	    		...
	    		window.location='DCList.jsp?customer_id='+customer_id+'&site_id='+site_id+"&invoice_date="+invoice_date+"&invoice_id="+invoice_id+"&vehicle_no="+vehicle_no;
	    	});
	    });
    </script>
    <script type="text/javascript">
