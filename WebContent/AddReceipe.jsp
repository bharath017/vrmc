                ...
                <c:choose>
                	<c:when test="${param.action=='update'}">
                		...
                		<sql:query var="rec" dataSource="jdbc/rmc">
                			select * from receipe where receipe_id=?
                		...
                		<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" action="MixDesignController?action=UpdateReceipe" method="post">
			                            		...
			                            		<table class="table table-bordered table-condensed">
			                            			...
			                            			<tbody>
			                                         ...
			                                         pattern="[^'&quot;:]*$"  value="${rs.aggregate1_name}"  id="aggregate1_name"  name="aggregate1_name"/>
			                            					...
			                            					<td>
			                            						<input type="number" class="form-control agval" 
			                                         ...
			                                         pattern="[^'&quot;:]*$"  value="${rs.aggregate2_name}"    id="aggregate2_name"  name="aggregate2_name"/>
			                            					...
			                            					<td>
			                            						<input type="text" class="form-control agval" 
			                                         ...
			                                         pattern="[^'&quot;:]*$"  value="${rs.aggregate11_value}"   id="aggregate11_value"  name="aggregate11_value"/>
			                            				...
			                            				<tr>
			                            					<td colspan="3">Total Density : </td>
			                            					<td class="show-density"></td>
                	...
                	<c:otherwise>
                		<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" action="MixDesignController?action=InsertReceipe" method="post">
			                        <div class="card-box row col-sm-12">
			                           	<div class="col-sm-6">
			                           		<div class="form-group">
			                                    <label>Receipe Code : </label>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				var showDensity=function(){
					var net_sum=0;
					$('.agval').each(function(){
						var agval=($(this).val().trim()=='')?0:parseFloat($(this).val());
						net_sum+=agval;
					});
					$('.show-density').text(net_sum);
				}
				
				$('.agval').on('keyup blur',function(){
					showDensity();
				});
				showDensity();
			});
