...
<head>
        <meta charset="utf-8" />
        <title>Indent Report ${initParam.company_name}</title>
                        ...
                        <div class="card-box">
							...
							<div class="text-center mt-4 mb-4">
                                ...
                                <sql:query var="leave" dataSource="jdbc/rmc">
                               		SELECT count(e.indent_id) as count FROM indent e WHERE e.status="inactive"
								</sql:query>	
								
									<c:forEach var="leave" items="${leave.rows}">                                
                                     <div class="col-xs-6 col-sm-3">
                                    	<a href="IndentList.jsp?status=inactive">
                                        <div class="card-box bg-primary widget-flat border-primary text-white">
                                            <i class="fi-archive"></i>
                                            <h3 class="m-b-10">Pending List</h3>
                                ...
                                <sql:query var="resignaion" dataSource="jdbc/rmc">
                               		SELECT count(e.indent_id) as count FROM indent e WHERE e.status="approved" 
								</sql:query>
								
                                    <c:forEach var="resignaion" items="${resignaion.rows}"> 
                                    <div class="col-xs-6 col-sm-3">
                                    	<a href="IndentList.jsp?status=approved">
                                        <div class="card-box widget-flat border-success bg-success text-white">
                                            <i class="fi-help"></i>
                                            <h3 class="m-b-10">Approved List</h3>
