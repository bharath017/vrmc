...
<head>
	...
	<div class="wrapper">
		<div class="container-fluid">
			...
			<div class="row">
					 <div class="col-sm-4">
                        <a href="VehicleServiceList.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i>Vehicle Service List</a>
                    </div>
             </div>
			<div class="row">
				<div class="col-sm-12">
					
							<form action="VehicleServiceController?action=InsertService" method="post" id="service-form">
							...
							<div class="col-sm-6">
							 ...
							 <div class="form-group">
									...
									<select id="vehicle_type"  name="vehicle_type" required="required"   class="select2"  data-placeholder="Choose Vehicle Type">
										<c:forEach var="plant" items="${plant.rows}">
										<option value="${plant.vehicle}">${plant.vehicle}</option>
										</c:forEach>
									</select>
	                            </div>
								...
								<div class="form-group">
                                       <label>Date <span class="text-danger"></span> </label>
                                           ...
                                           <div class="input-group">
                                               <input type="text" name="date"   class="form-control date-picker issued_date"  placeholder="yyyy-mm-dd" id="id-date-picker-1" data-date-format="yyyy-mm-dd">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-group">
                                            <input type="text" name="time"  class="form-control"  placeholder="HH:MM:SS" id="timepicker1" data-date-format="yyyy-mm-dd">
                                            <div class="input-group-append">
	                            ...
	                            <div class="form-group">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                           placeholder="Previous Service KM Reading" id="last_skm" readonly name="last_skm"/>
                                    </div>
	                            </div>
	                            ...
	                            <div class="form-group">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                           placeholder="Enter Present KM Reading"  id="present_skm" name="present_skm"/>
                                    </div>
	                            </div>
	                            ...
	                            <div class="form-group">
                                    ...
                                    <div>
                                       <input type="text" class="form-control" 
                                          placeholder="Enter Service Cost"   id="service_cost" name="service_cost"/>
                                    </div>
	                            </div>
                                </div>
                                  </div>
