              	...
              	<c:choose>
              		<c:when test="${param.action=='update'}">
                		...
                		<sql:query var="payment" dataSource="jdbc/rmc">
                		    ...
                		    from customer_payment p where payment_id=?
			                        	...
			                        	<div class="col-sm-4">
			                               ...
			                               <div class="form-group">
			                                    ...
			                                    <sql:query var="marketing" dataSource="jdbc/rmc">
			                                        ...
			                                        from bank_detail b LEFT JOIN (business_group g)
			                                        ON b.business_id=g.business_id
			                                        WHERE b.business_id like if(?=0,'%%',?) or b.business_id is null
			                                        <sql:param value="${bean.business_id}"/>
			                                        <sql:param value="${bean.business_id}"/>
			                                    </sql:query>
												<select id="bank_detail_id"  name="bank_detail_id" required="required"   class="select2"  data-placeholder="Choose Bank Detail">
													...
													<option value="${marketing.bank_detail_id}" ${(marketing.bank_detail_id==pay.bank_detail_id)?'selected':''}>${marketing.bank_name} - (${marketing.group_name})</option>
													</c:forEach>
												</select>
			                                </div>
              		...
              		<c:otherwise>
              			<div class="row">
		                    <div class="col-sm-12">
		                    	<form class="" id="myform" action="PaymentController?action=InsertPayment" method="post">
			                        <div class="card-box row col-sm-12">
			                        	<div class="col-sm-4">
											 <div class="form-group">
			                                    <label>Customer <span class="text-danger">*</span></label>
