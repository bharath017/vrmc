            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Unit Settings</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-center">
                    	<a href="AddGrade.jsp" class="btn btn-custom waves-effect waves-light mb-4"  data-toggle="modal" data-target="#add-comp" data-overlayColor="#36404a"><i class="mdi mdi-plus"></i>New Unit</a>
                    		...
                    		<tbody>
                    			<c:forEach items="${unit.rows}" var="unit">
                    				<tr>
										...
										<td>
											<a href="#delete-model" class="text-danger" onclick="deleteUnit('${unit.unit_id}','${unit.unit_name}');" data-animation="blur" data-plugin="custommodal"  data-overlaySpeed="100" data-overlayColor="#36404a">
                      ...
                      <div class="modal-dialog" >
                          <div class="modal-content" style="width: 100%;">
                              ...
                              <div class="modal-body" >
                                  ...
                                  <form class="form-horizontal" action="SettingController?action=InsertUnit" method="post">

                                      <div class="col-sm-12">
                                          <div class="form-group m-b-25">
	                                          <div class="col-12">
	                                              <label for="username">New Unit</label>
	                                              <input class="form-control" type="text" id="unit_name" name="unit_name" required="" placeholder="Enter Unit Name">
	                                          </div>
	                                      </div>
                                      </div>
                                      <div class="col-sm-12">
