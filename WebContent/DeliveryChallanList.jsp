       ...
       <%@ include file="header.jsp" %>
        ...
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Delivey Challan List</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="AddDeliveryChallen.jsp" class="btn btn-custom waves-effect waves-light mb-4"
                        		  data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add Delivery Challan </a>
                    </div><!-- end col -->
                </div>
                <!-- end row -->
                <form id="clear-form">
				<div class="row filter-row">
					...
					<div class="col-sm-2 col-xs-6">
                        <div class="form-group form-focus">
                            <label class="control-label">DC No <span class="text-custom">*</span></label>
                                <input class="form-control" placeholder="Enter DC No.." id="dc_id" type="text" name="dc_id">
                        </div>
                    </div>
                    <div class="col-sm-2 col-xs-6">
                     ...
                     <div class="col-sm-2 col-xs-6">
                        <div class="form-group form-focus select-focus">
                            ...
                            <select class="form-control floating" id="site_id" name="site_id">
        ...
        <script type="text/javascript" src="js/DC/DeliveryChallanList.js"></script>
