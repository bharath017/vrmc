$(document).ready(function(){
	...
	$('.picker').on('click',function(){
	 ...
	 var table =   $('#example').DataTable({
	        ...
	        lengthChange: true,
	        "ajax":{
	        	url:"PurchaseVoucherController?action=getAllPurchaseVoucherList",
	        	type:"POST",
	        	 data 	: function ( d ) {
		                  return $.extend( {}, d, {
	    	    ...
	    	    buttons: {
	    	        confirm:{
	    	            ...
	    	            action: function(){
	    	                $.ajax({
	    	                	type:'post',
	    	                	url:'PurchaseVoucherController?action=CancelPurchaseVoucher&purchase_voucher_id='+purchase_voucher_id,
	    	    ...
	    	    buttons: {
	    	        confirm:{
	    	            ...
	    	            action: function(){
	    	                $.ajax({
	    	                	type:'post',
	    	                	url:'PurchaseVoucherController?action=deletePurchaseVoucher&purchase_voucher_id='+purchase_voucher_id,
	    	                	success:function(res){
	    	                		table.draw();
	    	                		$.toast({
